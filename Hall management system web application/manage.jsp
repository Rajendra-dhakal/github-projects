<%-- 
    Document   : manage
    Created on : 6 Sep, 2017, 12:53:55 PM
...
function f1()
{
location.href ="ui.jsp";
}
function f2()
{
alert("THE HALL IS UPDATED");
}
function f3()
{
alert("THE HALL IS REMOVED");
}
function f4()
{
alert("THE HALL IS ADDED");
}
</script>
<style>
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Paris')">REMOVE</button>
  <button class="tablinks" onclick="openCity(event, 'Tokyo')">UPDATE</button>
</div>

<div id="London" class="tabcontent">
  <h3>ADD HALLS IN CHENNAI </h3>
  <center>
<table>
<tr>
<td>HALL NAME:</td>
...
<tr>
<td>AVAILABLE:</td>
<td><input type="text" id="t3" name="mob" ></td>
</tr>
</table>
      <button class="button button2" onclick="f4()">
        <i class="fa fa-plus"></i> ADD</button>
</center>
</div>
<div id="Paris" class="tabcontent">
  <h3>REMOVE HALLS IN CHENNAI</h3>
  <center>
<table>
<tr>
<td>HALL NAME:</td>
<td><input  type="text" id="q" name="name"  ></td>
</tr>
<tr>
<td>OWNER:</td>
<td><input type="text" id="q1" name="mob" ></td>
</tr>
</table>
      <button class="button button2" onclick="f3()">
        <i class="fa fa-times"></i> REMOVE</button>
</center>
</div>
<div id="Tokyo" class="tabcontent">
  <h3>UPDATE HALLS IN CHENNAI</h3>
  <center>
<table>
<tr>
<td>HALL NAME:</td>
...
<tr>
<td>ADDRESS:</td>
<td><input type="text" id="w1" name="mail" ></td>
</tr>
<tr>
<td>OWNER:</td>
<td><input type="text" id="w2" name="mob" ></td>
</tr>
<tr>
<td>AVAILABLE:</td>
<td><input type="text" id="w3" name="mob" ></td>
</tr>
</table>
      <button class="button button2" onclick="f2()">
        <i class="fa fa-wrench"></i> UPDATE</button>
</center>
</div>
<BR><BR><BR>
<button class="button button2" onclick="f1()">
