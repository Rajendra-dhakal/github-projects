<%-- 
    Document   : ui
    Created on : 6 Sep, 2017, 12:46:26 PM
...
<br><br><br>
<br><br><br><br>
<button class="button button2" onclick="f1()"><i class="fa fa-user-circle-o"> CONTRACTOR </i></button>
<button class="button button2" onclick="f2()"><i class="fa fa-user"> CUSTOMER</i></button>
  </div>
