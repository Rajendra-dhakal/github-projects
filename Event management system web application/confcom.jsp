...
<header>
<article>
<center><h1 style="color:green">GLOBAL CONFERENCE MANAGEMENT SYSTEM<BR>
CHOICES FOR CUSTOMER</h1>
</center>
</article>
</header>
</div>
...
<br><br><br>
<br><br><br><br>
<button class="button button2" onclick="f1()"><i class="fa fa-user-circle-o"></i> DIRECT</button>
<button class="button button2" onclick="f2()"><i class="fa fa-user"></i> INDIRECT</button>
  </div>
