<%-- 
    Document   : indirect
    Created on : 6 Sep, 2017, 12:56:44 PM
...
tr:nth-child(odd){background-color: #f1e6f1}
th {
...
<button class="button button2" onclick="f1()"><i class="fa fa-thumbs-up"></i> PROCEED</button>
    ...
    <br><br><br><br><br>
<br><center><p style="color:#00cccc;font-size:24px;font-family:Copperplate Gothic Light;font-weight:bold">FOLLOW US ON:
